...
urlpatterns = [
    ...
    path('<int:event_id>/deregister/', views.event_deregister, name='specific-event-deregister'),
    ...
    path('<int:event_id>/release-payment/', views.release_payment, name='release-payment'),
]
